import 'dart:io';
import 'package:shitf/Patient/full_screen_image.dart';
import 'package:shitf/Patient/message.dart';
...
class ChatScreenForDoctor extends StatefulWidget {
  String name;
  String photoUrl;
  String receiverUid;
  ChatScreenForDoctor({this.name, this.photoUrl, this.receiverUid});

  _ChatScreenForDoctorState createState() => _ChatScreenForDoctorState();
}

class _ChatScreenForDoctorState extends State<ChatScreenForDoctor> {
  Message _message;
  ...
  Future<DocumentSnapshot> getSenderPhotoUrl(String uid) {
    ...
    Firestore.instance.collection('Online Consulting patients').document(uid).get();
