...
import 'package:shitf/Doctor/chat_screen_for_doctor.dart';
import 'package:shitf/main.dart';
String doc;
bool showDustbin=false;

class AllPatientScreenForDoctor extends StatefulWidget {
  @override
  _AllPatientScreenForDoctorState createState() => _AllPatientScreenForDoctorState();
}

class _AllPatientScreenForDoctorState extends State<AllPatientScreenForDoctor> {
                ...
                onTap: ((){
                  Navigator.push(
                      ...
                      new MaterialPageRoute(
                          builder: (context) => ChatScreenForDoctor(
